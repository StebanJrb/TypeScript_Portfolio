  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 py-20 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-[35%_65%] gap-12 items-center mb-16">
          {/* Columna izquierda: Foto y Nombre */}
          <div className="flex flex-col items-center lg:items-start">
            <div className="relative mb-6">
              <div className="w-64 h-64 rounded-full border-4 border-primary/30 glow-border overflow-hidden bg-secondary">
                <img
              ...
              <div className="absolute -bottom-2 -right-2 w-8 h-8 rounded-full bg-primary border-4 border-background animate-pulse" />
            </div>
            <h2 className="text-3xl md:text-4xl font-bold text-foreground text-center lg:text-left glow-text leading-tight">
          ...
          <div className="flex flex-col justify-center">
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold glow-text text-center lg:text-left">
        ...
        <div className="text-center max-w-5xl mx-auto">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            ...
            <Button size="lg" className="glow-border font-mono" asChild>
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-primary/30 hover:bg-primary/10 font-mono bg-transparent"
              asChild
            >
